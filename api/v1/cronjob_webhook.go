...
func (r *CronJob) validateCronJob() error {
	...
	return apierrors.NewInvalid(GroupVersion.WithKind("CronJob").GroupKind(), r.Name, allErrs)
}

func (r *CronJob) validateCronJobName() *field.Error {
	if len(r.Name) > validation.DNS1035LabelMaxLength-11 {
		return field.Invalid(field.NewPath("metadata").Child("name"), r.Name, "name must be no more than 52 characters")
	}
	return nil
}

func (r *CronJob) validateCronJobSpec() *field.Error {
	return r.validateScheduleFormat(r.Spec.Schedule, field.NewPath("spec").Child("schedule"))
}

func (r *CronJob) validateScheduleFormat(schedule string, fldPath *field.Path) *field.Error {
